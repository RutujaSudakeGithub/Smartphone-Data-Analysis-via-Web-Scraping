# -*- coding: utf-8 -*-
"""data_cleaning_smartphone_1_090625ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1V_UCcLbkOhcwl3RyY3EgpYbaI_037Gp8
"""
...
df1[df1['index'].isin(processor_rows | ram_rows |display_rows|camera_rows|battery_rows)]
# processor_rows | ram_rows |display_rows|camera_rows|battery_rows
...
df1.loc[temp_df.index,temp_df.columns[7:]].shape
...
df1.loc[temp_df.index,'card'] = 'Memory cards not supported'

df1['card'].value_counts()

temp_df=df1[df1['os'].str.contains('Memory Card Not Supported')]

df1.loc[temp_df.index,['os']]='No Version'
...
temp_df=df1[df1['card'].str.contains('Memory cards not supported')]
...
df1.insert(1,'brand_names',brand_name)
...
df1['num_cores']=df1['num_cores'].str.strip().str.replace('Octa Core Processor','Octa Core').str.replace('Hexa Core Processor','Hexa Core')
...
df1.loc[[439,762],['ram_capacity','internal_memory']] =[[4.0,'64'],[4.0,'64']]
...
num_front_camera=df1['camera'].str.strip().str.split('&').str.get(1).str.strip().fillna('Missing').apply(camera_extractor2)
...
# df1.loc[69,'num_front_camera'] ='50 Mp'
